                ...
                <div className='grid grid-cols-2 justify-center items-center gap-2'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <input type="text" id='banns' className='border rounded-md p-2 outline-none' 
                      {...register('banns', {
                        required: `Banns is required`
                      })}
                    />
                    {error.banns && <span className='text-red-500 text-sm '>{error.banns.message}</span>}
                  </div>
                  ...
                  <div className='flex flex-col'>
                    ...
                    />
                    {error.license && <span className='text-red-500 text-sm '>{error.license.message}</span>}
                  </div>
                  ...
                  <div className='flex flex-col'>
                    ...
                    <input type="text" id='organist' className='border rounded-md p-2 outline-none' 
                      {...register('organist', {
                        required: `Organist is required`
                      })}
                    />
                    {error.organist && <span className='text-red-500 text-sm '>{error.organist.message}</span>}
                  </div>
                  ...
                  <div className='flex flex-col'>
                    ...
                    />
                    {error.flowers && <span className='text-red-500 text-sm '>{error.flowers.message}</span>}
                  </div>
